...
discussions:
  - id: "core-governance-disc-1"
    ...
    body: |
      ...
      - **Token Governance**: Fair distribution and voting mechanisms
      - **Investment Pool Oversight**: Transparent allocation decisions
      ...
      6. Investment pool access inequities
    ...
    comments:
      ...
      nodes:
        - id: "comment-1"
          body: |
            I think we should prioritize asynchronous participation methods to accommodate different time zones and token governance fairness.
            
            Some suggestions:
            - Extended comment periods
            - Rolling polls rather than live votes
            - Multiple discussion formats (text, video, voice)
            - Weighted token voting with time-delay protection
            - Investment pool proposal review periods
        ...
        - id: "comment-3"
          body: |
            We should also consider translation and cultural context. Not everyone processes information or makes decisions the same way. This applies to both governance participation and token economics understanding.
            ...
            - Token economics education materials
            - Investment pool allocation visualizations
  ...
  - id: "core-governance-disc-3"
    number: 3
    title: "Token Economics and Investment Pool Governance Framework"
    body: |
      As DAHAO evolves, we need clear frameworks for token governance and investment pool management.
      
      ## Investment Pool Allocation Principles
      
      - **Transparency**: All allocation decisions publicly recorded on-chain
      - **Community Voting**: Token holder approval for major investments
      - **Impact Measurement**: ROI tracking for governance improvements
      - **Diversification**: Balanced allocation across domains and initiatives
      ...
      ### Investment Decisions (Supermajority 67%)
      - Investment pool allocations >10% of treasury
      - Long-term strategic partnerships
      - Technology infrastructure investments
      - Cross-domain funding initiatives
      
      ## Alex Investment Example
      
      **Scenario**: Alex holds 2.5% of governance tokens and proposes investing 500,000 tokens in an AI transparency tool development.
      
      **Process**:
      1. Alex submits detailed proposal with ROI projections
      2. Community review period (14 days)
      3. Token holder vote with 67% threshold
      4. If approved, investment pool allocates tokens
      5. Quarterly progress reviews with token holder oversight
      
      **Governance Benefits**:
      - Democratic investment decisions
      - Aligned incentives between token holders and outcomes
      - Transparent resource allocation
      - Community-driven priority setting
      
      How should we balance individual initiative with collective governance?
    ...
    author:
      id: "user-15"
      login: "token-economics-lead"
      avatarUrl: "https://avatars.githubusercontent.com/u/15?v=4"
      url: "https://github.com/token-economics-lead"
    labels:
      totalCount: 3
      nodes:
        - id: "label-11"
    ...
    comments:
      ...
      nodes:
        - id: "comment-11"
          body: |
            This framework balances individual initiative with collective oversight well. 
            
            **Key strengths**:
            - Clear thresholds prevent token holder fatigue
            - Supermajority requirement for major investments protects treasury
            - Regular reviews ensure accountability
            
            **Suggested additions**:
            - Minimum holding period before voting rights (prevent vote buying)
            - Delegation mechanisms for passive token holders
            - Quorum requirements to ensure broad participation
          createdAt: "2024-01-26T09:20:00Z"
          updatedAt: "2024-01-26T09:20:00Z"
          upvoteCount: 8
          author:
            id: "user-16"
            login: "governance-analyst"
            avatarUrl: "https://avatars.githubusercontent.com/u/16?v=4"
            url: "https://github.com/governance-analyst"
        - id: "comment-12"
          body: |
            The Alex investment example is helpful for understanding the process flow.
            
            **Real-world considerations**:
            - What happens if investment fails to meet ROI targets?
            - How do we handle conflicts of interest (Alex investing in own proposals)?
            - Should there be investment pool insurance or risk mitigation?
            
            **Alternative approach**: Investment committees with term limits and token holder oversight could reduce direct conflicts while maintaining democratic control.
          createdAt: "2024-01-28T16:45:00Z"
          updatedAt: "2024-01-28T16:45:00Z"
          upvoteCount: 12
          author:
            id: "user-17"
            login: "risk-management-expert"
            avatarUrl: "https://avatars.githubusercontent.com/u/17?v=4"
            url: "https://github.com/risk-management-expert"
    answer: null
```
      ...
      - id: "comment-16"
        body: |
          ...
          **Economic Harm Categories**:
          - **Resource limitation**: Artificially constraining access to necessary resources, including investment pool exclusion
          - **Information asymmetry**: Withholding critical information that affects decision-making, including token economics transparency
          - **Choice architecture manipulation**: Designing systems to exploit cognitive biases, including governance token voting manipulation
      ...
      - id: "comment-17"
        body: |
          ...
          **Integration with Current Definition**:
          ...
          ✅ Token economics integration provides concrete governance applications
...
discussions:
  - id: "D_kwDOAE5jvM4AQz5K"
    ...
    body: |
      ...
      - Institutional bias
      - Investment pool exclusion
      - Token governance manipulation
      ...
      nodes:
        - id: "DC_kwDOAE5jvM4AQ0A1"
          body: |
            ...
            - Cultural erasure
            - Token distribution inequities
            - Investment pool access barriers
        ...
        - id: "DC_kwDOAE5jvM4AQ0A2"
          body: |
            ...
            2. Measurable
            3. Enforceable
            4. Token-economics compatible
            
            Perhaps we need a tiered approach with investment pool oversight?
    ...
    nodes:
      - id: "comment-1"
        body: |
          ...
          - **Economic**: Access to resources, investment opportunities, token participation
      ...
      - id: "comment-4"
        body: |
          ...
          **Environmental dimension encompasses**:
          ...
          - **Economic**: Investment in sustainable infrastructure, green token rewards
      ...
      - id: "comment-5"
        body: |
          ...
          - `economics:investment` - resource allocation for wellbeing enhancement
      ...
      - id: "comment-12"
        body: |
          ...
          **Integration with Token Economics**:
          - Investment pool allocations prioritize wellbeing enhancement
          - Token holder voting considers multidimensional wellbeing impact
          - Economic incentives align with wellbeing optimization
